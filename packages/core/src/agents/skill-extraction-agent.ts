...
function buildSystemPrompt(
  ...
  return [
    ...
    `- Global personal memory: write complete markdown drafts under ${memoryDir}/.inbox/global/ only.`,
    `- Project/shared instructions: write complete markdown drafts under ${memoryDir}/.inbox/project-instructions/ using paths relative to the project root (for example GEMINI.md or docs/GEMINI.md).`,
